...
class TensorRTYOLO:
    ...
    def postprocess(self, output, scale, dw, dh, conf_threshold=0.25, nms_threshold=0.4):
        ...
        try:
            ...
            boxes_nms = np.column_stack([x1, y1, x2 - x1, y2 - y1])
...
def main():
    parser = argparse.ArgumentParser(description='TensorRT YOLO com Frame Skipping e FPS Corrigido')
    ...
    detector = TensorRTYOLO(args.engine, args.input_size)
    ...
    try:
        while True:
            ...
            if current_time - last_stats_time >= stats_interval:
                ...
                period_fps = stats_frame_count / elapsed
            ...
            cv2.imshow('TensorRT YOLO - Frame Skipping', frame)
        ...
        # Estatísticas finais
        total_time = time.time() - last_stats_time
        ...
        print(f"Taxa de processamento: {processed_frames/frame_count*100:.1f}%")
